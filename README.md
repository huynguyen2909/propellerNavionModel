...
nonlinear 6-DOF Navion. Bản này được dựng lại trong thư mục mới, không sửa nối
tiếp implementation trước.

Mục tiêu của V1 là làm rõ calculation flow và interface trước khi có đủ dữ liệu
hình học/polar thật. Mọi con số của NACA 5868-9/Clark-Y đang dùng đều là
placeholder có chủ ý, không phải dữ liệu validation.
...
- [`docs/PROPELLER_V1_CALCULATION_FLOW.md`](docs/PROPELLER_V1_CALCULATION_FLOW.md):
  sơ đồ nhiều cấp của đúng implementation C++, vai trò của toàn bộ tham số tĩnh,
  runtime input/output, thuật toán BEMT, safeguarded inflow solver và đối chiếu
  cấu trúc với UH-1;
- [`docs/MODEL_EQUATIONS.md`](docs/MODEL_EQUATIONS.md): phương trình và bản đồ
  nguồn;
- [`docs/VERIFICATION.md`](docs/VERIFICATION.md): các kiểm tra tự động.
...
docs/PROPELLER_V1_CALCULATION_FLOW.md
